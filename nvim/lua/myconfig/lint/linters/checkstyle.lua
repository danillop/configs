...
local function config()
  if M.config_file == nil then
    error "Missing checkstyle config. e.g.: `require('lint.linters.checkstyle').config_file = '/Users/marcuspereira/apps/quintoandar/owner-properties-listing/config/checkstyle/checkstyle.xml'`"
  end
